...
var id = 5;
var templateLiterals = "http://localhost:3000/api/messages/".concat(id, "/hellow,").concat(id);
var _house$mouse = {
  house: 5,
  mouse: 6
},
    house = _house$mouse.house,
    mouse = _house$mouse.mouse;
...
Object(_scripts_data__WEBPACK_IMPORTED_MODULE_1__["data"])();
